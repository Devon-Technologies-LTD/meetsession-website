...
import { Mic, FolderOpen, MessageSquare, Globe, Shield } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-600">
            Your smart legal companion for recording, transcribing, and
            organizing meetings, all in one app.
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              <div className="flex-1">
                ...
                <p className="text-teal-50 mt-5 text-md font-semibold leading-relaxed">
                  We help legal professionals capture every word, stay
                  organized, and access case notes anytime, anywhere.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-start gap-4">
              <div className="flex-1">
                ...
                <p className="text-teal-50 mt-5 text-md font-semibold text-lg leading-relaxed">
                  Built for the realities of Board Rooms and chambers, fast,
                  accurate, and secure.
                </p>
              </div>
            </div>
