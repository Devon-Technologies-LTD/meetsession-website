  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <p className="text-sm font-normal md:font-light max-w-full md:max-w-96">Meet session helps lawyers and organizations record meetings or cross-examinations and stores them neatly in folders for instant access.</p>
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <Link href="/waitlist" className={cn(buttonVariants({ variant: "brand-blue", size: "lg" }), "h-12 w-full md:w-fit")}>Join Waitlist</Link>
        </div>
      </div>
