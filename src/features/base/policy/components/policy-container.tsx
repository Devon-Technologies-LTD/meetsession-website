      ...
      <section className="min-h-fit w-full flex flex-col gap-8">
        ...
        <div className="flex items-start gap-20 min-h-fit">
          <aside className={cn(
            ...
            "py-5 px-6 min-h-fit h-fit w-64 font-raleway",
            "flex flex-col gap-4",
            "sticky top-24",
          )}>
          ...
          <main className="flex-1 flex flex-col gap-2 font-dm-sans">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex flex-col gap-2.5">
                <p className="text-lg font-semibold">2. Definitions </p>
                <p className="text-base">
                  “Consent” of the Data Subject means any freely given, specific, informed, and unambiguous expression of the Data Subject&apos;s wishes, where they, through a statement or clear affirmative action, demonstrate consent to the processing of their personal data
                  “Controller”The entity that determines the purposes and means of processing personal data.
                  “Data” means characters, symbols, and binary data on which a computer performs operations. This data may be stored or transmitted as electronic signals, and can be saved in any format or on any device.
                  “Data Subject” means any individual who can be identified, either directly or indirectly, through an identification number or one or more attributes related to their physical, physiological, mental, economic, cultural, or social identity.
                  “NDPR” means the Nigeria Data Protection Regulation, 2019.
                  “NDPA” means the Nigeria Data Protection Act, 2023.
                  “Our Services or Software” means all software developed by Devon Technologies Limited
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <p className="text-base">We may request access or permission to and track location-based information from your computer. If you wish to change our access or permissions, you may do so in your device&apos;s settings.</p>
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <p className="text-base"> Contract performance, Legitimate Interest (maintaining service availability)</p>
                <p className="text-lg font-semibold">User Control:</p>
                <p className="text-base">Account closure or service termination will stop this processing, except where retention is required by law.</p>
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                <p className="text-lg font-semibold">Lawful Basis:</p>
                <p className="text-base">Legitimate Interest</p>

                <p className="text-lg font-semibold">User Control:</p>
                <p className="text-base">You may opt out of non-essential analytics via our cookie banner or in-app settings.</p>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <p>
                  ...
                  The Company will take all necessary steps to ensure that the Personal Data is transmitted in a safe and secure manner. Details of the protection given to your

                  information when it is transferred outside Nigeria shall be provided upon the Data Subject’s request.
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <p>
                  The security of your personal data is a top priority for Devon Technologies. We have implemented a combination of technical, organizational, and physical safeguards to ensure the
                  confidentiality, integrity, and availability of personal data, in line with NDPR, NDPA, and internationally recognized best practices.
              ...
              <div className="flex flex-col gap-2.5">
                <p className="text-lg font-semibold">Training</p>
                <p>The Company shall ensure that employees who collect, access and process Personal Data receive adequate data privacy and protection training in order to develop the necessary knowledge, skills and competence required to effectively manage the compliance framework under this Privacy Policy, the NDPR and the Nigeria Data Protection Act (2023) with regard to the protection of Personal Data. On an annual basis, the Company shall develop a capacity building plan for its employees on data privacy and protection in line with the NDPR and the Nigeria Data Protection Act (2023)</p>
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <br />
                <br />
                <p className="border-t border-b py-4 pr-5 w-[50%] italic">
